...
class MyNoopResetEnv(gym.Wrapper):
    """
...
class MyFireResetEnv(gym.Wrapper):
    """
...
class MyMaxAndSkipEnv(gym.Wrapper):
    """
...
class MyClipRewardEnv(gym.RewardWrapper):
    """
...
class MyAtariWrapper(gym.Wrapper):
    ...
    * Clip reward to {-1, 0, 1}
    ...
    def __init__(
        ...
        env = MyNoopResetEnv(env, noop_max=noop_max)
        env = MyMaxAndSkipEnv(env, skip=frame_skip)
        ...
        super(MyAtariWrapper, self).__init__(env)
